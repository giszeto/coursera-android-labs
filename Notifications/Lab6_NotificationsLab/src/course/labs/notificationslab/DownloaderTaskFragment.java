...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        downloadTask.execute(R.raw.tswift, R.raw.rblack, R.raw.lgaga);
    ...
    public class DownloaderTask extends AsyncTask<Integer, Void, String[]> {
        ...
        protected String[] doInBackground(Integer... params) {
            Integer[] resources = new Integer[params.length];
            for (int i = 0; i < params.length; i++) {
                resources[i] = params[i];
            }
            return downloadTweets(resources);
        }
                ...
                new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        ...
                        if (!(getResultCode() == MainActivity.IS_ALIVE)) {
                            ...
                            final PendingIntent pending = PendingIntent.getActivity(context,
                                0,
